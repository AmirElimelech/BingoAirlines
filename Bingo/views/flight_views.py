...
def handle_search_form_submission(request):
    ...
    try:
        # form = SearchForm(request.POST) # i've commented this line and added the next line to make the function work with the react app 
        # update = working 100% 
        # tesing sending this payload in postman as RAW JSON
            #{
            #     "numAdults": 2,
            #     "numChildren": 1,
            #     "cabinType": "ECONOMY",
            ...
            #     "departureDate1": "2023-09-10",
            #     "flightType": "Return",
            #     "departureDate2": "2023-09-20"
            # }

        # and got results as expected
